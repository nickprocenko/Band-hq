...
create policy "enable_read_bands" on public.bands for select using (true);
create policy "enable_write_bands" on public.bands for all using (true) with check (true);
...
create policy "enable_read_rehearsals" on public.rehearsals for select using (true);
create policy "enable_write_rehearsals" on public.rehearsals for all using (true) with check (true);
...
create policy "enable_read_performances" on public.performances for select using (true);
create policy "enable_write_performances" on public.performances for all using (true) with check (true);
...
create policy "enable_read_other_events" on public.other_events for select using (true);
create policy "enable_write_other_events" on public.other_events for all using (true) with check (true);
...
create policy "enable_read_band_members" on public.band_members for select using (true);
create policy "enable_write_band_members" on public.band_members for all using (true) with check (true);
...
create policy "enable_read_member_song_lists" on public.member_song_lists for select using (true);
create policy "enable_write_member_song_lists" on public.member_song_lists for all using (true) with check (true);
...
create policy "enable_read_rehearsal_songs" on public.rehearsal_songs for select using (true);
create policy "enable_write_rehearsal_songs" on public.rehearsal_songs for all using (true) with check (true);
...
create policy "enable_read_event_setlist_songs" on public.event_setlist_songs for select using (true);
create policy "enable_write_event_setlist_songs" on public.event_setlist_songs for all using (true) with check (true);
...
create policy "enable_read_rehearsal_song_requests" on public.rehearsal_song_requests for select using (true);
create policy "enable_write_rehearsal_song_requests" on public.rehearsal_song_requests for all using (true) with check (true);
...
create policy "enable_read_request_approvals" on public.request_approvals for select using (true);
create policy "enable_write_request_approvals" on public.request_approvals for all using (true) with check (true);
